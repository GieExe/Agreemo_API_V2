...
Revision ID: 30eacef50ec8
Revises: f872f2dd4365
Create Date: 2025-04-03 23:52:22.453194
...
revision = '30eacef50ec8'
down_revision = 'f872f2dd4365'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('sale_logs', schema=None) as batch_op:
        ...
        batch_op.alter_column('timestamp',
               ...
               nullable=False)
        batch_op.drop_constraint('sale_logs_sale_id_fkey', type_='foreignkey')
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('sales', schema=None) as batch_op:
        batch_op.add_column(sa.Column('sale_id', sa.INTEGER(), server_default=sa.text("nextval('sales_sale_id_seq'::regclass)"), autoincrement=True, nullable=False))
    ...
    with op.batch_alter_table('sale_logs', schema=None) as batch_op:
        ...
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key('sale_logs_sale_id_fkey', 'sales', ['sale_id'], ['sale_id'])
        batch_op.alter_column('timestamp',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               nullable=True)
